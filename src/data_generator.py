"""
Generate sample data for energy-transition-planner.
...
COLUMNS = ["year", "scenario", "coal_production_mt", "revenue_usd_m", "capex_renewable_usd_m", "carbon_cost_usd_m", "npv_usd_m"]
